...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        /// <summary>
        /// Tweens a Text's singText from one integer to another, with options for thousands separators
        /// </summary>
        ...
        /// <summary>Tweens a Text's singText to the given value.
        /// Also stores the Text as the tween's target so it can be used for filtered operations</summary>
        /// <param name="endValue">The end string to tween to</param><param name="duration">The duration of the tween</param>
        /// <param name="richTextEnabled">If TRUE (default), rich singText will be interpreted correctly while animated,
        /// otherwise all tags will be considered as normal singText</param>
        ...
        /// <param name="center">Circle-center/pivot around which to rotate (in GameplayUI anchoredPosition coordinates)</param>
