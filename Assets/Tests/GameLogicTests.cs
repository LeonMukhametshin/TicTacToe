...
namespace Tests
{
    ...
    public class GameLogicTests
    {
        ...
        public void CheckHorizontalCheinOne()
        {
            ...
            cells[Vector2Int.zero].Get<Taken>().data = BaseSign.fistSign;
        ...
        public void CheckHorizontalCheinTwoLeft()
        {
            ...
            cells[new Vector2Int(2, 0)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(1, 0)].Get<Taken>().data = BaseSign.fistSign;
        ...
        public void CheckHorizontalCheinTwoVertical()
        {
            ...
            cells[new Vector2Int(0, 1)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(0, 2)].Get<Taken>().data = BaseSign.fistSign;
        ...
        public void CheckHorizontalCheinThreeVertical()
        {
            ...
            cells[new Vector2Int(0, 0)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(0, 1)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(0, 2)].Get<Taken>().data = BaseSign.fistSign;
        ...
        public void CheckHorizontalCheinThreeDiagonalOther()
        {
            ...
            cells[new Vector2Int(0, 2)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(1, 1)].Get<Taken>().data = BaseSign.fistSign;
            cells[new Vector2Int(2, 0)].Get<Taken>().data = BaseSign.fistSign;
